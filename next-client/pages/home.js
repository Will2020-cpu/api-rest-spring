                        ...
                        <div className="flex items-center justify-center px-10 py-8">
                            <form  className="space-y-4">
                                <div className="flex flex-col space-y-1">
                                    ...
                                    <input type="text" id="inputUsername" placeholder="spiderman" className="border p-2 rounded-sm focus:outline-none focus:ring-2 focus:ring-green-400 focus:border-transparent" />
                                </div>
                                <div className="flex flex-col space-y-1">
