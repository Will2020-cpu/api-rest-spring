                            ...
                            <form className="space-y-4">
                                <div className="flex flex-col space-y-1">
                                    ...
                                    <input
                                        ...
                                        className="border p-2 rounded-sm focus:outline-none focus:ring-2 focus:ring-green-400 focus:border-transparent"
                                    />
                                </div>
                                <div className="flex flex-col space-y-1">
                                ...
                                <div className="w-full">
                                    <button
                                        type="submit"
                                        className="w-full p-2 text-white rounded-sm bg-black"
                                    >
                                        Ingresar
                                    </button>
                                </div>
